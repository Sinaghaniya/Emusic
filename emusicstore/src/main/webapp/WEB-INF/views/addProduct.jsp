    ...
    <div class="container">
        ...
        <div class ="form-group">
         <label for="category">Category</label>
            ...
            <label class ="checkbox-inline">
                <form:radiobutton path="productCategory" id="category" value="accesory"/>Accessory
            </label>
        </div>
        ...
        <div class ="form-group">
            ...
            <label class ="checkbox-inline">
                <form:radiobutton path="productCategory" id="condition" value="used"/>Used
            </label>
        ...
        <div class="form-group">
            ...
            <form:input id="productImage" path="productImage" type="file" class="from:input-large"/>
        </div>
